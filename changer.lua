...
local b = _:New({Name = "                                     Tezzyworks", FolderToSave = "SolarisLibStuff"})
local _ = b:Tab("Info")
...
a:Button(
    ...
    function()
        ...
        _:SetCore("SendNotification", {Title = "SecretSupply", Text = "! Tezzy#5147", Duration = 15})
    end
)
a:Button(
    "Discord Server",
    function()
        ...
        wait(0.5)
        setclipboard("https://discord.gg/XT5AFmxZfV")
    end
)
h:Button(
    "Blackvalk",
